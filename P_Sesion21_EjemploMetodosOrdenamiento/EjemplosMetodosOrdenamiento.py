...
mo.mostrarVector(None, mo.vector1000(None))
...
while(opcion != 10):
    ...
    if(opcion == 1):
        ...
        mo.ordenamientoBurbuja1(None, mo.vector1000(None))
        mo.ordenamientoBurbuja1(None, mo.vector10000(None))
        mo.ordenamientoBurbuja1(None, mo.vector100000(None))
        mo.ordenamientoBurbuja1(None, mo.vector1000000())
        #mo.ordenamientoBurbuja1(None, lista)
        ...
        mo.ordenamientoBurbuja2(None, mo.vector1000(None))
        mo.ordenamientoBurbuja2(None, mo.vector10000(None))
        mo.ordenamientoBurbuja2(None, mo.vector100000(None))
        mo.ordenamientoBurbuja2(None, mo.vector1000000(None))
        ...
        mo.ordenamientoBurbuja3(None, mo.vector1000(None))
        mo.ordenamientoBurbuja3(None, mo.vector10000(None))
        mo.ordenamientoBurbuja3(None, mo.vector100000(None))
        mo.ordenamientoBurbuja3(None, mo.vector1000000(None))
        ...
        mo.ordenamientoPorSeleccion(None, mo.vector1000(None))
        mo.ordenamientoPorSeleccion(None, mo.vector10000(None))
        mo.ordenamientoPorSeleccion(None, mo.vector100000(None))
        mo.ordenamientoPorSeleccion(None, mo.vector1000000(None))
        ...
        mo.ordenamientoPorInsercion(None, mo.vector1000(None))
        mo.ordenamientoPorInsercion(None, mo.vector10000(None))
        mo.ordenamientoPorinsercion(None, mo.vector100000(None))
        mo.ordenamientoPorInsercion(None, mo.vector1000000(None))
